              ...
              <div class="d2-crud-body">
                <el-table :data="tableData" style="width: 100%" height="710">
                  ...
                  <el-table-column label="状态" width="240" align="center">
                    <template slot-scope="scope">
                      <div>
                        ...
                        >
                          <svg t="1604906659996" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="8223" width="32" height="32"><path d="M512 102.4a409.6 409.6 0 1 0 409.6 409.6 409.6 409.6 0 0 0-409.6-409.6z m181.248 518.144a51.2 51.2 0 0 1-72.704 72.704L512 584.192l-108.544 109.056a51.2 51.2 0 0 1-72.704-72.704L439.808 512 330.752 403.456a51.2 51.2 0 0 1 72.704-72.704L512 439.808l108.544-109.056a51.2 51.2 0 0 1 72.704 72.704L584.192 512z" fill="#646a73" p-id="8224"></path></svg>
                          <span>{{ scope.row.status }}</span>
                        </div>
                        <div
                          class="by-status light-info"
                        ...
                        >
                          <svg t="1604906766166" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="9368" width="32" height="32"><path d="M512 1024a512 512 0 1 1 0-1024 512 512 0 0 1 0 1024z m-71.318588-361.411765a29.334588 29.334588 0 0 0 20.48-8.252235L774.625882 349.364706a27.708235 27.708235 0 0 0 0-39.936 29.575529 29.575529 0 0 0-41.08047 0l-292.74353 284.912941L290.454588 448.150588a29.575529 29.575529 0 0 0-41.08047 0 27.708235 27.708235 0 0 0 0 39.996236l170.706823 166.128941a29.274353 29.274353 0 0 0 20.540235 8.252235z" fill="#34c724" p-id="9369" data-spm-anchor-id="a313x.7781069.0.i24" class="selected"></path></svg>
                          <span>{{ scope.row.status }}</span>
                        </div>
                      </div>
                    </template>
                  ...
                  <el-table-column label="操作" width="100" align="right">
                    <template slot-scope="scope">
                      <div>
                        <el-button type="primary" size="small" @click="$router.push({ path: '/costCnter/vouchers-detail/'+scope.row.id })">详情</el-button>
                      </div>
                    </template>
                  </el-table-column>
                </el-table>
